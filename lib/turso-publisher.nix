# The Turso snapshot publisher, built from the SQLite driver source.
#
...
# read-only, atomic rename. See the package's README.
#
#   mkTursoPublisher { inherit pkgs; src = sqlite-database-integration; }
{
  pkgs,
  src,
  rustPkgs ? pkgs,
